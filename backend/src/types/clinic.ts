...
export type AppointmentStatus = 'confirmed' | 'waiting' | 'done'
...
export type Appointment = { id: string; branchId: string; patientName: string; service: string; startsAt: string; status: AppointmentStatus }
